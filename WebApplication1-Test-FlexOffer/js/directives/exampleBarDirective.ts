...
module app.Directives {
    ...
    export function ngSparkline(): ng.IDirective {
        ...
        return {
            ...
            link: function (scope: ISparklineScope, iElement, iAttrs, ctrl) {
                ...
                scope.$watch('weather', function (newVal) {
                    ...
                    if (newVal) {
                        ...
                        angular.forEach(scope.weather, value => {
    ...
    var chartGraphTwo = function (element, data, attrs) {
        ...
        svg.selectAll('text')
            ...
            .append('text')
            .text(d => { return d; })
            .attr('x', (d, i) => { return xScale(i) + 20; })
            .attr('y', d => { return yScale(d) + 15; })
            .attr("dy", ".71em");
    ...
    export function ngCity(): ng.IDirective {
        return {
